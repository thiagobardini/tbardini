...
const CardsPortfolio = ({ id, title, description, img, techs, live, readme, github }) => {
        ...
        <Box key={id} sx={{ display: "flex", justifyContent: "center" }}>
            <StyledCard onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                ...
                <StyledBottomBar>
                    ...
                    {github === "" ? (
                        <Button component={Link} to={readme} variant="outlined" color={darkMode ? "primary" : "secondary"} onClick={() => window.scrollTo(0, 0)}>
                            Readme
                        </Button>
                    ) : (
                        <Button
